...
namespace Soenneker.Mistral.OpenApiClient.Models
{
    ...
    public partial class DocumentLibraryTool : IParsable
    #pragma warning restore CS1591
    {
        /// <summary>Ids of the library in which to search.</summary>
...
#nullable restore
        ...
        /// </summary>
        /// <returns>A <see cref="global::Soenneker.Mistral.OpenApiClient.Models.DocumentLibraryTool"/></returns>
        /// <param name="parseNode">The parse node to use to read the discriminator value and create the object</param>
        public static global::Soenneker.Mistral.OpenApiClient.Models.DocumentLibraryTool CreateFromDiscriminatorValue(IParseNode parseNode)
        {
            if(ReferenceEquals(parseNode, null)) throw new ArgumentNullException(nameof(parseNode));
            return new global::Soenneker.Mistral.OpenApiClient.Models.DocumentLibraryTool();
        }
        /// <summary>
